...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 503.0, 534.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "slide~ 50 50"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 132.0, 200.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 236.0, 445.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 449.0, 171.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 171.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 132.0, 89.0, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 444.0, 284.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 503.0, 500.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 1.0, 0, 95.744682, 0.273333, 0, 1000.0, 0.0, 0 ],
					"id" : "obj-69",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 444.0, 342.5, 200.0, 100.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.5, 301.0, 97.5, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 243.0, 97.5, 33.0 ],
					"style" : "",
					"text" : "FUNDAMENTAL\nFREQ"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 184.0, 113.0, 20.0 ],
					"style" : "",
					"text" : "SCALE PARTIALS"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 54.321442, 115.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 564.178589, 18.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 399.714294, 387.916016, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 170.0, 281.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 254.0, 213.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 170.0, 440.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 248.5, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 511.0, 45.0, 45.0 ],
					"style" : ""
				}
